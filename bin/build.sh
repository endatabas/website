...
(
    ...
    perl -p0e 's/.*<table>/<table>/s' references.html > ../../src/partials/_ref_table.html.tmp
    perl -p0e 's/<\/table>.*/<\/table>\n/s' ../../src/partials/_ref_table.html.tmp > ../../src/partials/_ref_table.html
    perl -p0e 's/<title>references.bib<\/title>/<title>references.bib<\/title>\n<link rel="stylesheet" href="\/resources\/css\/dark.css" media="(prefers-color-scheme: dark)" \/>\n<link rel="stylesheet" href="\/resources\/css\/light.css" media="(prefers-color-scheme: light)" \/>\n<link rel="stylesheet" href="\/resources\/css\/bib_bib.css" \/>/g' references_bib.html > ../../src/references_bib.html
